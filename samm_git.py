    ...
    while (k < len(fileList)):
        ...
        for i in fileList:
            ...
            if (k == end):
                ...
                totalflow = np.array(non_maximum_suppression(totalflow, 0.33))  # 把所有通道融合起来
                totalflow = np.array(non_maximum_suppression(totalflow, 0.33))
